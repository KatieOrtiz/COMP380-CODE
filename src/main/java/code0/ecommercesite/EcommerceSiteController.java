...
public class EcommerceSiteController {
	...
	/**
	 * Mapping for the /signup page after user clicks the button to signup and
	 * checks user signup form for errors.
	 * 
	 * @param user          the user that signed up
	 * @param bindingResult Spring's object that holds the result of the validation
	 *                      of the model object, the binding, and any errors that
	 *                      may have occurred
	 * @param model         holds application data, which is displayed in the view
	 * @return String return the html page signup_form if errors or return html page
	 *         signup_success if successful
	 */
	@PostMapping("/signup")
	...
	/**
	 * Mapping for /login, connects to login page and displays the login form for
	 * user login.
	 * 
	 * @param model holds application data, which is displayed in the view
	...
	/**
	 * Mapping for the /login page after user clicks the log in button and checks
	 * user login form for errors.
	 * 
	 ...
	 * @return String return the html page login
	 */
	// go from login to loginsuccess, reads user.txt, if username and pw are same
	// from what is entered to what is in user.txt,
